...
public class QSlimfinderOptionsPanel extends JPanel {
    ...
    public QSlimfinderOptionsPanel() {
    ...
    public QSlimfinderOptions getQSLiMFinderOptions()
    {
        QSlimfinderOptions qslimfinderOptions = new QSlimfinderOptions();
